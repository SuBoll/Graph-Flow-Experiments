...
The file `nonisomorphic_4v12e_SZ_5_overview.png` in the directory
is an overview figure generated by running `generate_nonisomorphic_4v12e.py`.
Readers can also run the script themselves to regenerate the figure.
